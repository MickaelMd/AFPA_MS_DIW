<nav class="navbar bg-body-tertiary navbar-expand-md fixed-top bg-blur">
    <div class="container-fluid">
        <a class="navbar-brand nav_marg" href="http://localhost:3000/The_District/index.php">
            <img src="http://localhost:3000/The_District/assets/img/the_district_brand/nav_logo.svg" alt="Bootstrap"
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item nav_cent_res">
                    <a class="nav-link" aria-current="page"
                        href="http://localhost:3000/The_District/html/categorie.php">Catégorie</a>
                </li>
                <li class="nav-item nav_cent_res">
            ...
            <span class="navbar-text  ms-auto">
                <a class="nav-link log_sign_nav" href="http://localhost:3000/The_District/html/log_sign.php">Connexion /
                    Inscription</a>
            </span>
        </div>
    </div>
...
<div id="ex1" class="paralaxbox">
    <div id="ex1-layer">
        <img src="http://localhost:3000/The_District/assets/img/the_district_brand/big_white_logo.svg"
        ...
        <div class="row height d-flex justify-content-center align-items-center">
            <div class="col-md-6">
                <div class="form">
                    ...
                    <span class="left-pan"><img src="http://localhost:3000/The_District/assets/img/search.svg"
                            alt="" /></span>
                </div>
            </div>
        </div>
