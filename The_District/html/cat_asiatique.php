        ...
        <div id="cards_section_p_c">
          <div class="card mb-3" id="cards_plat_all" style="max-width: 540px">
            <div class="row g-0">
              <div class="col-md-4">
                <img
                  src="../assets/img/category/asian_food_cat.jpg"
          ...
          <div class="card mb-3" style="max-width: 540px">
            <div class="row g-0">
              <div class="col-md-4">
                <img
                  src="../assets/img/food/poulet_legume_asiatique.jpg"
                  class="img-fluid rounded-start"
                  alt="..."
                />
              </div>
          ...
          <div class="card mb-3" style="max-width: 540px">
            <div class="row g-0">
              <div class="col-md-4">
                <img
                  src="../assets/img/food/Nouilles_riz_poulet.jpg"
                  class="img-fluid rounded-start"
                  alt="..."
                />
              </div>
