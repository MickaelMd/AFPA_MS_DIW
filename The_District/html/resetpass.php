            ...
            <form action="" method="POST">
                ...
                <div class="row">
                    <div class="mb-3 mt-5 text-center">
                        ...
                        <span id="error-reset_email" class="text-danger"></span>
...
if (isset($_POST['reset_submit'])) {
    ...
    $req = $mysqlClient->prepare(query: 'SELECT id, nom, prenom, email, telephone, adresse, pass, active, resetcode, admin FROM clients WHERE email = :email');
            ...
            <form action="" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary w-50 mt-3"
                            name="reset_code_submit">Réinitialiser</button>
